...
public:
	...
	bool check_bullet_collision(std::mt19937_64& i_random_engine, const IntRect& i_bullet_hitbox);

	unsigned char check_powerup_collision(const IntRect& i_player_hitbox);
